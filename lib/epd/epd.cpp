...
/*******************************************************************************
* Function Name  : void epd_draw_rect(int x0, int y0, int x1, int y1)
* Description    : 
* Input          : 
* Output         : None
* Return         : 
...
* Description    : 注意：clear會依據epd_set_color所設定的bkColor去將整個畫面填滿
* Input          : 
* Output         : None
* Return         : 
* Attention		   : None
...
/*******************************************************************************
* Function Name  : void __RoundRect::setColor(unsigned char innerColor, unsigned char outlineColor)
* Description    : set the color of round rect to draw
* Input          : innerColor, outlineColor
* Output         : None
* Return         : 
* Attention		   : None
*******************************************************************************/
void __RoundRect::setColor(unsigned char innerColor, unsigned char outlineColor) {
	this->innerColor = innerColor;  this->outlineColor = outlineColor;
}

/*******************************************************************************
* Function Name  : void __RoundRect::setRadius(int r)
* Description    : set radius of round rect to draw
* Input          : r
* Output         : None
* Return         : 
* Attention		   : None
*******************************************************************************/
inline void __RoundRect::setRadius(int r) { 
	this->radius = r;
}

/*******************************************************************************
* Function Name  : void __RoundRect::draw(int x0, int y0, int x1, int y1)
* Description    : draw a filled rounded rectangle from x0,y0 to x1,y1
* Input          : x0, y0, x1, y1
* Output         : None
* Return         : 
* Attention		   : None
*******************************************************************************/
void __RoundRect::draw(int x0, int y0, int x1, int y1) {
	// corner background
	epd_set_color(innerColor, WHITE);
	epd_fill_circle(x0+radius, y0+radius, radius);
	epd_fill_circle(x1-radius, y0+radius, radius);
	epd_fill_circle(x0+radius, y1-radius, radius);
	epd_fill_circle(x1-radius, y1-radius, radius);
	// corner outline
	epd_set_color(outlineColor, WHITE);
	epd_draw_circle(x0+radius, y0+radius, radius);
	epd_draw_circle(x1-radius, y0+radius, radius);
	epd_draw_circle(x0+radius, y1-radius, radius);
	epd_draw_circle(x1-radius, y1-radius, radius);
	// outline of top, bottom, left and right edge
	epd_set_color(outlineColor, WHITE);
	epd_draw_line(x0+radius, y0, x1-radius, y0);
	epd_draw_line(x0+radius, y1, x1-radius, y1);
	epd_draw_line(x0, y0+radius, x0, y1-radius);
	epd_draw_line(x1, y0+radius, x1, y1-radius);
	// cover the needless partial circle
	epd_set_color(innerColor, WHITE);
	epd_fill_rect(x0+radius, y0+1, x1-radius, y1-1);
	epd_fill_rect(x0+1, y0+radius, x1-1, y1-radius);
}

__RoundRect RoundRect;